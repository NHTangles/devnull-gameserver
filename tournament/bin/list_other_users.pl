...
# This script prints out a list of all non-tournament-player users
# to STDOUT. Used so that the central server can avoid assigning 
# usernames that conflict with existing usernames on gameservers.
